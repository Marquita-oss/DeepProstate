    ...
    def _validate_paths(self):
        ...
        for path_name, path_value in paths_to_validate:
            try:
                ...
                # Don't create directories automatically - only validate the path
                # Directories will be created when actually needed
...
class SecureConfigManager:
    ...
    def _validate_path(self, path: str, path_type: str, create_if_missing: bool = False) -> str:
        try:
            ...
            # Don't create directories by default - only when explicitly requested
