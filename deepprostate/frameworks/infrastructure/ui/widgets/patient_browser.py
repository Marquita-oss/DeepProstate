...
class PatientBrowserPanel(QWidget):
    ...
    def __init__(self, repository: DICOMImageRepository, parent=None):
    ...
    def _setup_connections(self):
        ...
        # Connect series_selected to cache-first handler
    ...
    def _on_series_selected(self, series_uid: str):
        """Handle series selection with cache-first logic."""
