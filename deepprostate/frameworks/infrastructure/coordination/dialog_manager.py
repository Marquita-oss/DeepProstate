...
from deepprostate.frameworks.infrastructure.utils.resources_path import get_icon_path
...
class DialogManager(QObject):
    ...
    def _center_dialog_on_parent(self, dialog: QWidget) -> None:
        ...
        """
        try:
            if not self._parent_window or not dialog:
                return
    ...
    def show_file_selection_dialog(self) -> DialogResult:
        try:
            ...
            single_btn.setIcon(QIcon(str(get_icon_path("upload_file.svg"))))
            ...
            folder_btn.setIcon(QIcon(str(get_icon_path("upload_folder.svg"))))
    ...
    def show_progress_dialog(self, title: str = "Processing", 
        ...
        try:
            ...
            if self._parent_window:
                self._center_dialog_on_parent(self._current_progress_dialog)
