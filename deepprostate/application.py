...
from deepprostate.frameworks.infrastructure.utils.resources_path import (
    get_logo_path, get_main_log_file, ensure_data_directories,
    get_logs_dir, get_data_dir, get_dicom_storage_dir
)


class DeepProstateApplication:
    """
    DeepProstate - Medical imaging application with Clean Architecture.
    """
    ...
    def _setup_medical_environment(self) -> logging.Logger:
        ...
        logger = setup_medical_logging(
            ...
            log_file=str(get_main_log_file())
        )

        # Create all necessary directories using centralized path manager
    ...
    def _setup_qt_application_properties(self) -> None:
        self._qt_application.setApplicationName("DeepProstate")
        self._qt_application.setApplicationVersion("")
        self._qt_application.setOrganizationName("Medical Imaging Lab")
        self._qt_application.setApplicationDisplayName("DeepProstate")
