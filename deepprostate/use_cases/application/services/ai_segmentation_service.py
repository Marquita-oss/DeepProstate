...
class AISegmentationService:
    ...
    async def predict_prostate_segmentation(
        ...
        Use AIAnalysisOrchestrator.run_ai_analysis() instead, which now handles
        the entire workflow with the simplified approach (predict_from_files).
        """
        raise NotImplementedError(
            "This method is deprecated. Use AIAnalysisOrchestrator.run_ai_analysis() instead."
        )
    
    # ===== DEPRECATED METHODS - Use AIAnalysisOrchestrator instead =====

    async def _predict_prostate_whole(self, image: MedicalImage, prepared_data: Dict[str, Any]) -> MedicalSegmentation:
        """DEPRECATED: Use AIAnalysisOrchestrator.run_ai_analysis() instead"""
        raise NotImplementedError("Deprecated method")

    async def _predict_prostate_zones(self, image: MedicalImage, prepared_data: Dict[str, Any]) -> List[MedicalSegmentation]:
        """DEPRECATED: Use AIAnalysisOrchestrator.run_ai_analysis() instead"""
        raise NotImplementedError("Deprecated method")

    async def _predict_lesions(self, image: MedicalImage, prepared_data: Dict[str, Any]) -> List[MedicalSegmentation]:
        """DEPRECATED: Use AIAnalysisOrchestrator.run_ai_analysis() instead"""
        raise NotImplementedError("Deprecated method")
