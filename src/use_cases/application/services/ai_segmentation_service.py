...
from src.core.domain.entities.segmentation import MedicalSegmentation, AnatomicalRegion
from src.core.domain.repositories.repositories import SegmentationRepository
from src.core.domain.services.ai_model_service import AIModelService
from src.core.domain.services.image_validation_service import ImageValidationService, ImageValidationError
from src.core.domain.services.ai_preprocessing_service import AIPreprocessingService, AIPreprocessingError
from src.core.domain.services.ai_inference_service import AIInferenceService, AIInferenceError
from src.core.domain.services.segmentation_conversion_service import (
