...
from src.core.domain.repositories.repositories import (
    MedicalImageRepository, SegmentationRepository
)
from src.use_cases.application.services.image_services import (
...
from src.frameworks.infrastructure.visualization.vtk_renderer import MedicalVTKRenderer
...
class MedicalServiceContainer:
    ...
    def _initialize_application_services(self) -> None:
        ...
        from src.frameworks.infrastructure.coordination.medical_format_registry import MedicalFormatRegistry
...
def create_medical_service_container(config_path: Optional[str] = None) -> MedicalServiceContainer:
    from src.frameworks.infrastructure.utils.secure_config import SecureConfigManager
