...
from src.core.domain.entities.medical_image import (
...
from src.frameworks.infrastructure.utils.dicom_metadata_extractor import dicom_extractor
...
class DICOMImageRepository(MedicalImageRepository):    
    ...
    async def update_image_metadata(
        ...
        try:
            from src.frameworks.infrastructure.utils.input_validator import InputValidator, ValidationError
