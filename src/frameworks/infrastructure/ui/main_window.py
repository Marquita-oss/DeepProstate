...
from src.frameworks.infrastructure.di.medical_service_container import MedicalServiceContainer
from src.frameworks.infrastructure.coordination.workflow_orchestrator import WorkflowOrchestrator
from src.core.domain.utils.universal_mask_visualizer import UniversalMaskVisualizer
from src.frameworks.infrastructure.data.unified_data_loader import UnifiedDataLoader
from src.frameworks.infrastructure.ui.widgets.collapsible_sidebar import CollapsibleSidebar
from src.frameworks.infrastructure.ui.widgets import ImageViewer2D
from src.frameworks.infrastructure.ui.widgets import PatientBrowserPanel
from src.frameworks.infrastructure.storage.dicom_repository import DICOMImageRepository
from src.core.domain.entities.medical_image import MedicalImage
...
class MedicalMainWindow(QMainWindow):
    ...
    def _setup_collapsible_sidebar(self, sidebar: CollapsibleSidebar, patient_browser, components):
        ...
        from src.frameworks.infrastructure.ui.widgets import AIAnalysisPanel
        from src.use_cases.application.services.ai_analysis_orchestrator import AIAnalysisOrchestrator
        ...
        from src.frameworks.infrastructure.ui.widgets.manual_editing_panel import ManualEditingPanel
        manual_panel = ManualEditingPanel()
        manual_panel.setParent(self)

        from src.frameworks.infrastructure.ui.widgets.quantitative_analysis_panel import QuantitativeAnalysisPanel
        quant_panel = QuantitativeAnalysisPanel()
        quant_panel.setParent(self)

        from src.frameworks.infrastructure.ui.widgets.image_information_panel import ImageInformationPanel
        image_info_panel = ImageInformationPanel()
        image_info_panel.setParent(self)

        sidebar.image_information_panel = image_info_panel

        sidebar.add_panel("ai_analysis", "AI Analysis", ai_panel, QIcon("resources/icons/ai_analysis.svg"))
        sidebar.add_panel("manual_editing", "Manual Editing", manual_panel, QIcon("resources/icons/manual_editing.svg"))
        sidebar.add_panel("quantitative", "Quantitative Analysis", quant_panel, QIcon("resources/icons/quantitative_analysis.svg"))
        sidebar.add_panel("image_info", "Image Information", image_info_panel, QIcon("resources/icons/image_information.svg"))
    ...
    def _on_show_about(self) -> None:
        ...
        import os
        logo_path = "resources/image/logo2.svg"
    ...
    def _on_ai_analysis_completed(self, result) -> None:
        try:
            ...
            from PyQt6.QtGui import QColor
            from src.core.domain.entities.segmentation import AnatomicalRegion
