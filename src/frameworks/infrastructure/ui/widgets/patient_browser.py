...
from src.core.domain.services.patient_data_management_service import PatientDataManagementService
from src.core.domain.services.medical_image_cache_service import MedicalImageCacheService
from src.core.domain.services.patient_search_service import PatientSearchService, SearchCriteria
from src.core.domain.services.batch_operation_service import BatchOperationService
from src.core.domain.services.sequence_analysis_service import SequenceAnalysisService
...
class PatientBrowserPanel(QWidget):
    ...
    def _setup_ui(self):
        ...
        try:
            from src.frameworks.infrastructure.ui.components import MedicalButton
